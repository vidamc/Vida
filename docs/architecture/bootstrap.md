...
Это «ленивое» применение трансформаций: класс патчится только когда JVM его _реально_ загружает. Моды, классы которых никогда не трогает игрок, не дают никаких накладных расходов в рантайме.
