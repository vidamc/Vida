...
`vida-entidad` появился в `0.5.0`; публичный API заморожен по SemVer начиная с линии 2.x (см. [api-stability.md](../reference/api-stability.md)).
...
- [`mundo`](./mundo.md) — координаты мира, высотные пределы, измерение, world-латидосы (`LatidosMundo`).
